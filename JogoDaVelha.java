...
public class JogoDaVelha {
    public static void main(String[] args) {
       ...
       btnResetar.addActionListener(new ActionListener() {
            public void actionPerformed (ActionEvent e) { // metodo do Java
                for (int  i = 0; i < 9; i++) {
                    botoes[i].setText("");
                }
                VezDoX[0] = true; // sempre o jogo começa com o x

                JOptionPane.showMessageDialog(null, "O Jogo foi reiniciado com sucesso");// exibe mensagem na Tela usando um MassageDialoge, informando que o jogo foi reiniciado com sucesso
